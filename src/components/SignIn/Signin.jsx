...
const SignIn = () => {
    ...
    return (
        ...
        <Fragment>
            <Grid container direction="row" className={clsx(classes.loginContainer, classesExternal.loginContainer)}>
                <Grid item container lg={6} justify="center" alignItems="center">
                    <Grid item>
                         <img src={login} className={clsx(classes.loginImage, classesExternal.loginImage)} />
                    </Grid>
                </Grid>
                <Grid item container direction="column" justify="center" alignItems="center" lg={6} className={clsx(classes.loginContainForm, classesExternal.loginContainForm)}>
                   <form>
                     <Grid>
                        <Grid item>
                            <TextField
                                className={clsx(classes.loginTextfield, classesExternal.loginTextfield)}
                                label="Email*"
                        ...
                        <Grid item style={{textAlign:"center"}}>
                            <Button className={clsx(classes.signInBtn, classesExternal.signInBtn)}>Sign In</Button>     
                        </Grid>
                        <Grid item style={{textAlign:"center"}}>
